...
//        var adminController = new AdminpageController(waitcontrol, new ReportView(), new VssVotingDataService()); // Manual create it here ? I am not sure, this is generated...
...
//        waitcontrol.startWait();
//        var votingController = new VotingpageController(waitcontrol, new VssVotingDataService());
